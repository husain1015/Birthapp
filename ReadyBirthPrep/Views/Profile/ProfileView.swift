...
struct ProfessionalCreditsView: View {
    let professionals = [
        ProfessionalCredential(
            ...
            certification: "APTA Board Certified Women's Health",
            bio: "15+ years specializing in prenatal and postpartum rehabilitation"
        ),
        ProfessionalCredential(
            name: "Maria Rodriguez",
            title: "Certified Prenatal Fitness Instructor",
            certification: "ACE, AFPA Prenatal/Postnatal Certified",
            bio: "Expert in safe exercise programming for all trimesters"
        ),
        ProfessionalCredential(
            name: "Emily Chen",
            title: "CD(DONA), Birth Doula",
            certification: "DONA International Certified",
            bio: "Supporting families through pregnancy, birth, and postpartum"
        )
    ]
