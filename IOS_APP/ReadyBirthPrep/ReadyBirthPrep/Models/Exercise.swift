...
struct Exercise: Codable, Identifiable {
    ...
    init(name: String, category: ExerciseCategory, benefit: ExerciseBenefit, description: String, instructions: [String], duration: TimeInterval, trimesterSuitability: [Trimester], createdBy: ProfessionalCredential, videoURL: String? = nil, thumbnailURL: String? = nil) {
        self.id = UUID()
        self.name = name
